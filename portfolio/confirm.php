...
//       $stmt->bindValue(':Contact', $contact);
      ...
      $stmt =$pdo->execute('INSERT INTO contact(corporate_name, name, telephone, email, contact_menu, contact, regist_date) VALUES('aaaa', 'aaaa', '1234', 'aaaa@aaaa', 'ssss', 'aaaa', CURRENT_TIMESTAMP())');
